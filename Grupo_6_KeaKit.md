...
*Aprendizajes y mejoras generales anotadas por el grupo 6.*

* 🟢 **Buenas Prácticas Identificadas:**
    * **Claridad estratégica:** Propuesta de incluir un resumen visual inicial de la idea de negocio.
    * **Definición de cliente ideal:** Incorporación de *persona profile* para concretar el target.
    * **Monetización:** Definición de modelo basado en comisiones.
    * **Usuarios piloto:** Planificación con incentivos y diferenciación por tipo de usuario.
    * **Logística:** Considerada como parte clave del modelo.
    * **Gestión por sprints:** Explicación visual mediante Gantt simplificado (3 sprints de 2 semanas).
    * **Herramientas de gestión:** Uso de Microsoft Teams y Clockify para organización y control.
    * **Stack tecnológico:** Resumido incluyendo riesgos asociados.
    * **Análisis de competencia:** Resumen visual de competidores.
    * **DAFO optimizado:** Mejorado visualmente (uso de colores y comparación directa amenazas vs. oportunidades).
    * **Narrativa visual:** Introducción progresiva de mockups para mantener atención.
    * **Interactividad:** Prototipo funcional visible en pantalla + QR para interacción.
    * **Branding:** Uso de mascota como elemento diferenciador de marca.
    * **Organización del equipo:** Fotos del equipo organizadas por sprint para explicar el reparto de trabajo.
    * **Validación:** Inclusión de cuestionario para recoger feedback de la app.
    * **Diseño de diapositivas:** Reducción de texto y uso de esquemas y tablas para facilitar la comprensión.
    * **Claridad conceptual:** Diferenciar correctamente entre **Core** y **MVP**. Si una funcionalidad es diferenciadora, debe formar parte del core.
    * **Organización interna:** Centralizar la comunicación operativa entre responsables de subgrupos para evitar ruido.
    * **Gestión del tiempo:** Incluir diapositivas de respaldo (*backup slides*) para ajustar tiempos sin improvisar.
    * **Puesta en escena (Killer Opener):** Proyectar la voz y mantener contacto visual frontal. La problemática debe ser clara desde el segundo uno.
    * **Apoyo visual constante:** Acompañar cada explicación (riesgos, mitigaciones, CI/CD) con elementos visuales específicos.
    * **Optimización de Mockups:**
        * Aplicar zoom en zonas relevantes y botones.
        * Identificar claramente el rol del usuario en cada pantalla.
        * Mantener un bloque coherente sin fragmentar la sección.
        * Acompañar metáforas visuales con texto aclaratorio y contexto narrativo.
    * **DAFO Estratégico:**
        * Asociar amenazas con oportunidades y debilidades con fortalezas compensatorias.
        * Uso de colores para comparativa visual directa.
        * Evitar términos subjetivos no medibles (ej: "interfaz innovadora").
    * **Gestión de Usuarios Piloto:**
        * Especificar número concreto de usuarios por perfil.
        * Definir el plan de interacción progresiva y validación con clientes reales.
    * **Rigor en Sprints:**
        * Incorporar feedback docente en la planificación, incluso si requiere replanificar.
        * Considerar periodos no lectivos en el cronograma real.
        * Explicar explícitamente la **Integración Continua** y viabilidad del despliegue.
        * Evitar diagramas de Gantt vacíos; deben aportar contenido explicativo.
    * **Cumplimiento y Evidencias:**
        * Aportar pruebas objetivas de cumplimiento en el *Commitment Agreement*.
        * Sustituir la "base de conocimiento" por un repositorio estructurado y verificable.

* 🔴 **Aspectos a seguir reforzando:**
    * **Apertura:** Falta de un resumen visual inicial potente.
    * **Segmentación:** Cliente ideal aún mejorable en concreción.
    * **Viabilidad:** El modelo de monetización necesita mayor desarrollo.
    * **Análisis interno:** El DAFO requiere una jerarquización más clara.
    * **Storytelling:** La integración narrativa de los mockups aún puede mejorar.
    * **Estrategia de crecimiento:** Captación y gestión de usuarios piloto más detallada.
    * **Conclusión:** El cierre final debe ser más memorable y alineado con el mensaje central.
    * **Navegación:** Inclusión de numeración de diapositivas para mayor control y referencia.
    * **Checklist de control:** Implementar una verificación final para asegurar que no falte ningún apartado obligatorio.
    * **Hilo argumental sólido:** La presentación debe fluir con un orden lógico:
        1. Quiénes somos.
        2. Problema y *Killer Opener*.
        3. Competidores.
        4. Propuesta diferencial.
        5. Desarrollo por Sprints.
    * **Coherencia Discurso–Visual:** Alineación total entre lo que se dice y lo que se muestra.
    * **Conexión entre ponentes:** Hilar intervenciones para que no parezcan bloques aislados (ej: retomar el problema inicial en la validación).
    * **Diseño dinámico:** Evitar diapositivas consecutivas con estructuras demasiado similares.
    * **Análisis competitivo:** Debe ser comparativo y estratégico, no meramente descriptivo.
    * **Mitigación de riesgos:** Explicar explícitamente cómo las acciones propuestas reducen el impacto o la probabilidad.